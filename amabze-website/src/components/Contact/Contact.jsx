...
export default function Contact({ selectedVehicle }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setReferenceId(`AMB-${(Math.random() * 89999 + 10000).toFixed(0)}`);
      setSubmitted(true);
    } catch (error) {
            ...
            <AnimatePresence mode="wait">
              {submitted ? (
                ...
                >
                  ...
                  <h3>Proposal Request Dispatched</h3>
                  <p>
                    Thank you. Reference ID: <strong>{referenceId ?? `AMB-${(Math.random() * 89999 + 10000).toFixed(0)}`}</strong>
                    <br />
                    Our travel desk team is generating your customized GST proposal.
                  </p>
